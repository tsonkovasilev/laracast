          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <x-nav-link href="/" :active="request()->is('/')" aria-current="page">Homeeto</x-nav-link>
                <x-nav-link href="/jobs" :active="request()->is('jobs')" aria-current="page">Jobs</x-nav-link>
                <x-nav-link href="/contact" :active="request()->is('contact')" aria-current="page">Kontakte</x-nav-link>
              </div>
            </div>
          </div>
          <div class="hidden md:block">
      ...
      <div class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
          <div class="flex items-center px-5">
            ...
            <div class="ml-3">
              <div class="text-base/5 font-medium text-white">Tsonko</div>
